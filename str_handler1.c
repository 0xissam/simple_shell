...
/**
 * _strlenght - return the nbr of char in str
 * @str: string input
...
/**
 * _strcompaire - compares two strings.
 *
...
/**
 * _strncompaire - compares two strings.
 *
 * @s1: input const string
 * @s2: input const string
 * @n: input int
...
/**
 * _strncpytodest - copy src to dest .
 *
 * @dest: input char *
...
/**
 * _strappendtosrc - appends the src string to the dest string,
 *
 * @dest: input string
